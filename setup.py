...
def get_version():
    ...
    path = os.path.join(os.path.dirname(__file__), 'uniprops', '__meta__.py')
...
setup(
    ...
    version=VER,
    python_requires=">=3.6",
    keywords='unicode re regex',
    description='Provide Unicode character group strings for regular expressions.',
    long_description=get_description(),
    long_description_content_type='text/markdown',
    author='Isaac Muse',
    author_email='Isaac.Muse@gmail.com',
    url='https://github.com/facelessuser/uniprops',
